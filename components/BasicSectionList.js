...
import {SectionList,Text,View,Alert,Platform} from 'react-native';
  ...
  render(){
    return(
        <View style={{
          ...
          <View style={{backgroundColor:'rgb(173,252,250)', height:1, margin:4, marginLeft:20,marginRight:10}}>
          </View>
